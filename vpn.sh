...
# Merubah nama client ovpn dengaan domain
...
cp /etc/openvpn/client-tcp-1194.ovpn /home/vps/public_html/${domain}-1194.ovpn
...
cp /etc/openvpn/client-udp-2200.ovpn /home/vps/public_html/${domain}-2200.ovpn
...
cp /etc/openvpn/client-tcp-ssl.ovpn /home/vps/public_html/${domain}-ssl.ovpn
